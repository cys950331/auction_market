...
public class BoardWrite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editStandard = findViewById(R.id.editStandard);
    ...
    public void CheckHandler(){
        if(editTitle.getText().toString().equals("")){
            ...
            Toast.makeText(this, "시작가격을 입력하세요", Toast.LENGTH_LONG).show();
        }
        else if((Integer.parseInt(editPrice.getText().toString()) < 100)){
            Toast.makeText(this,"100원보다 큰 시작가격을 입력하세요.", Toast.LENGTH_LONG).show();
        }
        else if(editStandard.getText().toString().equals("")) {
            Toast.makeText(this, "입찰단위를 입력하세요.", Toast.LENGTH_LONG).show();
        }
        else if (Integer.parseInt(editStandard.getText().toString()) < 100) {
            Toast.makeText(this, "입찰단위가 100보다 작을 수 없습니다", Toast.LENGTH_LONG).show();
        }
        else if (Integer.parseInt(editStandard.getText().toString()) % 100 != 0){
            Toast.makeText(this,"입찰단위는 100단위로 맞춰야 합니다.", Toast.LENGTH_LONG).show();
        }
